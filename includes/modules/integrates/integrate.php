...
class integrate
{
     ...
     * @return int
     */
    function add_user($username, $password, $email,$tname, $gender = -1, $bday = 0, $reg_date=0, $md5password='')
    {
        /* 将用户添加到整合方 */
    ...
    function edit_user($cfg)
    {
		...
		if (isset($cfg['tname']) && $this->field_tname != 'NULL')
        {
            $values[] = $this->field_tname . "='" . $cfg['tname'] . "'";
        }
