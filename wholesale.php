...
elseif ($_REQUEST['act'] == 'submit_order')
{
	...
	*/
    ...
    $order = array(
		...
		'pay_name'      => "<font color=blue>货款抵扣</font>",
        ...
        'best_time'    => $address_info['best_time'],
    ...
    /* 提示 */
	$order_info_url="user.php?act=order_detail&order_id=".$new_order_id;
    show_message(sprintf($_LANG['ws_order_submitted2'], $order['order_sn']), $_LANG['ws_return_order_info'], $order_info_url);
}
