...
<table class="table table-hover ectouch-table">
   ...
   <tr>
    ...
    <tr>
        <td width="200">每天免费抽奖次数</td>
        <td>
            <div class="col-md-4 col-sm-4">
                <input type="text" name="cfg_value[free_prize_num]" class="form-control" value="{$config['config']['free_prize_num']}" />
          </div>
        </td>
    </tr>
	<tr>
        <td width="200">付费抽奖消耗银币</td>
        <td>
            <div class="col-md-4 col-sm-4">
                <input type="text" name="cfg_value[xh_yinbi]" class="form-control" value="{$config['config']['xh_yinbi']}" />
          </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
                ...
                <table class="table ectouch-table prize_list">
                    ...
                    <tr>
						...
						<td class="text-center">
							<select name="cfg_value[prize_type][]" class="form-control">
								<option value="0" {if $v['prize_type'] == 0}selected{/if}>实物</option>
								<option value="1" {if $v['prize_type'] == 1}selected{/if}>银币</option>							
							</select>
						</td>
            ...
            <p class="help-block">注意：最多添加9项，银币格式为数字+银币，例如20银币</p>
            </div>
        </td>
    </tr>
    <tr>
