...
<div class="content-wrap">
	...
	<p style="text-align:center;">今天您还有<span id="free_prize_num" style="color:#f00;"><?php echo $config['free_prize_num']; ?></span>次免费抽奖机会</p>
    <div class="info-box">
...
<script type="text/javascript">
    $(function(){
        ...
        $('.point-btn').click(function(event, arg1){
            var lucky_l = POINT_LEVEL[$('.lucky').data('count')];
			//alert(arg1);
			if(arg1){
				var url='<?php echo url('wechat/plugin_action',array('name'=>'dzp','ky'=>'zf'))?>'
			}else{	
				var url='<?php echo url('wechat/plugin_action',array('name'=>'dzp'))?>'
			}
