...
<body>
	<div class="grid">
		...
		<div class="block">
			...
			<p >你还可抽奖的次数：<span class="num"><?php echo $config['free_prize_num'];?></span></p>
		</div>
		<div class="block">
	...
	<div id="dialog" class="yes">
		<div id="content"></div>
		<a href="javascript:;" id="link">领取奖品</a>
...
<script>
    $(function() {
        ...
        function wxch_result (arg1) {	
			wxch_stop;		
			if(arg1){
				var url='<?php echo url('wechat/plugin_action',array('name'=>'zjd','ky'=>'zf'))?>'
			}else{	
