...
class deppon
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.deppon.com/bill.asp" name="queryForm_' .$invoice_sn. '" target="_blank">'.
    ...
    function kuaidi100($invoice_sn){
        //$url = 'http://m.kuaidi100.com/query?type=debangwuliu&id=1&postid=' .$invoice_sn. '&temp='.time();
		$url = 'http://m.kuaidi100.com/index_all.html?type=debangwuliu&postid=' .$invoice_sn;
        return $url;
    }
