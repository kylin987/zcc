<?php echo $this->fetch('library/user_header.lbi'); ?>
 ...
 <div class="flow-consignee ect-bg-colorf">
     <section>
      <ul>
   		<li>
    		<div class="input-text"><b><?php echo $this->_var['lang']['username']; ?>：</b><span><input placeholder="<?php echo $this->_var['lang']['mobile']; ?>" name="username" type="text"  class="inputBg" id="username" datatype="*" ></span></div>
        </li>
        <li>
