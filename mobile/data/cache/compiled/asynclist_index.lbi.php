...
<a href="<?php echo $this->_var['hot_goods']['url']; ?>"><img src="<?php echo $this->_var['hot_goods']['goods_img']; ?>" alt="<?php echo $this->_var['hot_goods']['name']; ?>"></a>
  <dl>
    ...
    <dd class="dd-price"><span class="pull-left"><strong>商品总价：<b class="ect-colory"><?php if ($this->_var['hot_goods']['promote_price']): ?><?php echo $this->_var['hot_goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['hot_goods']['shop_price']; ?><?php endif; ?></b></strong> <!--<small class="ect-margin-lr">市场零售价：<?php echo $this->_var['hot_goods']['market_price']; ?></del></small></span> <span class="ect-pro-price"> -->
