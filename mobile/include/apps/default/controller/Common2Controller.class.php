...
class Common2Controller extends BaseController{
    ...
    public function __construct(){
		// 设置分销商id
        if (I('sale')){           
			cookie('sale_id',I('sale'),time()+3600); 
        }		
		if (! isset($_COOKIE['redirect_url'])) {
			cookie('redirect_url', __HOST__ . $_SERVER['REQUEST_URI']);
		}	
...
class_alias('Common2Controller', 'ECTouch');
