...
$_LANG['label_message'] = '咨询/留言';
$_LANG['label_tag'] = '我的标签';
$_LANG['label_collection'] = '喜欢/收藏';
...
$_LANG['label_user_yue'] = '我的余额';
$_LANG['label_user_gold'] = '我的金币';
$_LANG['label_user_silver'] = '我的银币';
$_LANG['label_user_jifen'] = '我的积分';
$_LANG['label_user_shouru'] = '我的收入';
...
$_LANG['add_gold_log'] = '金币';
$_LANG['add_hb_log'] = '红包';
$_LANG['add_sliv_log'] = '代金券明细';
$_LANG['add_jifen_log'] = '积分';
$_LANG['view_application'] = '资金流水';
$_LANG['surplus_pro_type'] = '类型';
$_LANG['repay_money'] = '金&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;额';
$_LANG['money'] = '金额';
$_LANG['surplus_type_0'] = '余额充值';
$_LANG['surplus_type_1'] = '资金管理';
$_LANG['deposit_money'] = '充值金额';
$_LANG['process_notic'] = '备注信息';
...
$_LANG['current_surplus'] = '您现金余额为：';
$_LANG['current_coin'] = '您代金券：';
$_LANG['current_gold'] = '您当前的可用红包为：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的金额超过了您现有的余额，此操作将不可进行！';
$_LANG['gold_amount_error'] = '您要申请提现的金币超过了您现有的金币，此操作将不可进行！';
...
$_LANG['return_goldcoin_on_cancel'] = '取消订单 %s，退回支付订单时使用的消费余额';
...
$_LANG['no_username'] = '推荐使用手机号码为用户名';
$_LANG['no_emaill'] = '输入邮箱，密码丢失后找回密码使用！';
$_LANG['no_tname'] = '必须输入真实姓名';
$_LANG['no_sfcode'] = '必须输入完整身份证号';
...
/* 微信昵称 */
$_LANG['nickname'] = '昵称';
$_LANG['no_nickname'] = '请输入昵称';

$_LANG['edit_headimg'] = '修改头像';
$_LANG['down_headimg'] = '同步微信头像';
...
$_LANG['agreement'] = "我已看过并接受《<a href=\"".url('article/info', array('aid'=>6))."\" style=\"color:blue\" target=\"_blank\">法律声明</a>》";
...
　　２、访问者点击链接，访问网店。
　　３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站注册，即认定该用户是您推荐的，您将获得贡献点数 <b>%d</b> 的奖励 (当您的贡献点数超过 <b>%d</b> 时，不再获得奖励)。
...
$_LANG['level_register_up'] = '贡献点数分成上限';
...
$_LANG['register_affiliate'] = '推荐会员ID %s ( %s ) 注册送贡献点数和银币';
$_LANG['register_affiliate2'] = '推荐会员ID %s ( %s ) 注册送贡献点数和银币';
...
$_LANG['to_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城贡献点数';
...
$_LANG['exchange_points'][0] = '商城贡献点数';
...
$_LANG['apply_sale_ok'] = '恭喜您，您已成为分销用户';
$_LANG['label_fenxiao2'] = '我的分销';
$_LANG['label_fenxiao'] = '我要分销';


$_LANG['wodebuluo'] = '我的客户';

$_LANG['is_daili'] = '您已经是代理了，请不要重复申请。<br>如需提高代理等级，请联系客服人员！';
