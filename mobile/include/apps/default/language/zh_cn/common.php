...
$_LANG['shop_closed'] = '盘点中，请您稍后再来...';
$_LANG['shop_register_closed'] = '该网店暂停注册';
$_LANG['shop_upgrade'] = "升级中，管理员从 <a href=\"admin/\">管理中心</a> 登录后，系统会自动完成升级";
...
$_LANG['free_goods'] = '包邮';
$_LANG['goumaiyagao'] = '购买牙膏';

$_LANG['maimaka'] = '买产品';
$_LANG['renshimaka'] = '认识芦荟';
$_LANG['makazixun'] = '芦荟资讯';
...
$_LANG['comment_custom'] = '评论失败。只有购买过商品的用户才能发表评论。';
...
$_LANG['order_already_received'] = '此订单已经确认过了，感谢您的购物，欢迎再次光临。';
$_LANG['order_invalid'] = '您提交的订单不正确。';
$_LANG['act_ok'] = '谢谢您通知我们您已收到货，感谢您的购物，欢迎再次光临。';
$_LANG['receive'] = '收货确认';
$_LANG['buyer'] = '买家';
...
$_LANG['ws_return_order_info'] = '立即完善订单';
$_LANG['wholesale'] = '批发';
...
$_LANG['ws_order_submitted2'] = '您的订单已提交成功，您的订单号是 %s，请及时完善您的收货信息。';
...
$_LANG['integral_not_enough'] = '您使用的代金券不能超过您拥有的代金券。';
$_LANG['integral_too_much'] = "您使用的代金券不能超过%d";
$_LANG['integral_too_less'] = "您使用的代金券不能少于%d";
$_LANG['invalid_bonus'] = "您选择的红包并不存在。";
$_LANG['no_goods_in_cart'] = '您的购物车中没有商品！';
$_LANG['not_submit_order'] = '您参与本次团购商品的订单已提交，请勿重复操作！';
$_LANG['pay_success'] = '本次支付已经成功，我们将尽快为您确认。';
...
$_LANG['goods_amount_not_enough'] = '您购买的商品没有达到最低限购金额 %s ，不能提交订单。';
$_LANG['balance_not_enough'] = '您账号余额不足以支付整个订单，请选择其他支付方式';
$_LANG['select_shipping'] = '您选定的配送方式为';
$_LANG['select_payment'] = '您选定的支付方式为';
$_LANG['change_payment'] = '或更换支付方式';
$_LANG['order_amount'] = '您的应付款金额为';
$_LANG['remember_order_number'] = '感谢您的购物！您的订单已提交成功，请记住您的订单号';
...
$_LANG['jianglihongbao'] = '奖励红包';
$_LANG['wodefensi'] = '我的粉丝';
