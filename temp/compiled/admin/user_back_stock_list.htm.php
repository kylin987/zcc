...
?> -->
<tr>
  <td align="center"><?php echo $this->_var['val']['s_id']; ?></td>
  <td><?php echo $this->_var['val']['user_id']; ?></td>
  <td><?php echo $this->_var['val']['user_name']; ?></td>
  <td><?php echo $this->_var['val']['nickname']; ?></td>
  <td><?php echo $this->_var['val']['rankname']; ?></td>
  <td><?php echo $this->_var['val']['tname']; ?></td>
  <td><?php echo $this->_var['val']['premium_value']; ?></td>
  <td><?php echo $this->_var['val']['premium_time']; ?></td>
  <td><?php echo $this->_var['val']['day_interest']; ?></td>
  <td><?php echo $this->_var['val']['days']; ?></td>
  <td><?php echo $this->_var['val']['all_interest']; ?></td>
  <td><?php echo $this->_var['val']['all_value']; ?></td>
  <td><?php echo $this->_var['val']['stock']; ?></td>  
  <td><?php echo $this->_var['lang']['do_type'][$this->_var['val']['do_type']]; ?></td>
