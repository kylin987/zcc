      <tr>
        ...
        <td>
          ...
          <input name="value[<?php echo $this->_var['var']['id']; ?>]" type="text" value="<?php echo $this->_var['var']['value']; ?>" style="width:300px" class="input_mlr" size="40" />
		  
		  <?php elseif ($this->_var['var']['type'] == "no_text"): ?>
		  <span><?php echo $this->_var['var']['value']; ?></span>
		  	
          <?php elseif ($this->_var['var']['type'] == "password"): ?>
          <input name="value[<?php echo $this->_var['var']['id']; ?>]" type="password" value="<?php echo $this->_var['var']['value']; ?>" class="input_mlr" size="40" />

          <?php elseif ($this->_var['var']['type'] == "textarea"): ?>
          <textarea name="value[<?php echo $this->_var['var']['id']; ?>]" cols="40" class="input_mlr_e" rows="5"><?php echo $this->_var['var']['value']; ?></textarea>
...
?>
          ...
          <?php if ($this->_var['var']['desc']): ?>
          <br />
          <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block;margin-top:11px;" <?php else: ?> style="display:none" <?php endif; ?> id="notice<?php echo $this->_var['var']['code']; ?>"><?php echo nl2br($this->_var['var']['desc']); ?></span>
          <?php endif; ?>
        </td>
