...
<div class="header">
	<div class="logo lf"><span class="invisible">千康元</span></div>
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="privilege.php?act=modif" target="main-frame"><?php echo $this->_var['lang']['profile']; ?></a><span>|</span><a href="message.php?act=list" target="main-frame"><?php echo $this->_var['lang']['view_message']; ?></a>
    <ul id="Skin">
    ...
    <div class="col-auto">
    	<div class="log white cut_line">&nbsp;&nbsp;您好！[管理员]<span>|</span><a href="privilege.php?act=logout"><?php echo $this->_var['lang']['signout']; ?></a><span>|</span>
    		<a href="../" target="_blank"><?php echo $this->_var['lang']['preview']; ?></a><span>|</span>
    		<a href="#"  onclick="ShowToDoList()"><?php echo $this->_var['lang']['todolist']; ?></a><span>|</span>
    		<a href="javascript:window.top.frames['main-frame'].document.location.reload();window.top.frames['header-frame'].document.location.reload()"><?php echo $this->_var['lang']['refresh']; ?></a><span>|</span><a href="index.php?act=clear_cache" target="main-frame" style="color:yellow"><?php echo $this->_var['lang']['clear_cache']; ?></a>
    	</div>
        <ul class="nav white" id="top_menu">
        <li><a href="privilege.php?act=modif" target="main-frame" hidefocus="true" style="outline:none;text-decoration:none;"><?php echo $this->_var['lang']['set_navigator']; ?></a></li>
        <li class="top_menu"><a href="index.php?act=main" target="main-frame" hidefocus="true" style="outline:none;text-decoration:none;"><?php echo $this->_var['lang']['admin_home']; ?></a></li>
...
?>
    <li class="top_menu"><a href="<?php echo $this->_var['key']; ?>" target="main-frame" hidefocus="true" style="outline:none;text-decoration:none;"><?php echo $this->_var['item']; ?></a></li>
