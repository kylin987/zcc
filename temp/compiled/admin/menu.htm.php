...
.tab-front {
  ...
  line-height: 35px;
  font-weight: bold;
  padding: 8px 15px 8px 18px;font-size:14px;
  border-right: 2px solid #838282;
  border-left: 2px solid #838282;
  color:#fff;
  cursor: hand;
  cursor: pointer;
}
...
.explode {
  background: url(images/menu_minus.gif) no-repeat 0px 11px;
  font-weight: bold;font-size:14px;
}
.collapse {
  background: url(images/menu_plus.gif) no-repeat 0px 11px;
  font-weight: bold;
}
.menu-item {
  background: url(images/menu_arrow.png) no-repeat 0px 9px;
...
<body>
<div id="tabbar-div">
<p><span style="float:right; padding: 3px 5px;" ><a href="javascript:toggleCollapse();" onfocus="this.blur()"><img id="toggleImg" src="images/menu_minus.gif" width="15" height="15" border="0" alt="<?php echo $this->_var['lang']['collapse_all']; ?>" /></a></span>
  <span class="tab-front" id="menu-tab">管理<?php echo $this->_var['lang']['menu']; ?></span>
</p>
</div>
<div id="main-div">
<div id="menu-list">
...
<?php if ($this->_var['menu']['action']): ?>
  <li class="explode" style="margin-left:8px; color:#666"><a href="<?php echo $this->_var['menu']['action']; ?>" target="main-frame"><?php echo $this->_var['menu']['label']; ?></a></li>
<?php else: ?>
  <li class="explode" key="<?php echo $this->_var['k']; ?>" name="menu" style="margin-left:8px;font-size:14px; color:#666">
...
?>
      <li class="menu-item" style="margin:-0px 0 0 -0px; font-size:12px;"><a href="<?php echo $this->_var['child']['action']; ?>" target="main-frame"><?php echo $this->_var['child']['label']; ?></a></li>
