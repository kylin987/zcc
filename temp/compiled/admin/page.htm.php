      ...
      <div id="turn-page" style="margin-top:8px;margin-right:10px;margin-bottom:5px;">
        ...
        <?php echo $this->_var['lang']['page_size']; ?> <input type='text' size='3' id='pageSize' value="<?php echo $this->_var['filter']['page_size']; ?>" onkeypress="return listTable.changePageSize(event)" style="width:30px;" />
        <span id="page-link">
