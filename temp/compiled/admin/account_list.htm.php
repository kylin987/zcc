...
<form method="post" action="account_log.php?act=list&user_id=<?php echo $_GET['user_id']; ?>" name="searchForm">
  <select name="account_type" onchange="document.forms['searchForm'].submit()">
	...
	<option value="gold_coin" <?php if ($this->_var['account_type'] == 'gold_coin'): ?>selected="selected"<?php endif; ?>><?php echo $this->_var['lang']['gold_coin']; ?></option>
  ...
  <strong><?php echo $this->_var['lang']['label_gold_coin']; ?></strong><?php echo $this->_var['user']['formated_gold_coin']; ?>
...
<?php endif; ?>
  ...
  <table cellpadding="10" cellspacing="1">
    <tr>
	  ...
	  <th><?php echo $this->_var['lang']['gold_coin']; ?></th>
...
?>
    <tr>
	  ...
	  <td align="right">
        <?php if ($this->_var['account']['gold_coin'] > 0): ?>
          <span style="color:#0000FF">+<?php echo $this->_var['account']['gold_coin']; ?></span>
        <?php elseif ($this->_var['account']['gold_coin'] < 0): ?>
          <span style="color:#FF0000"><?php echo $this->_var['account']['gold_coin']; ?></span>
        <?php else: ?>
          <?php echo $this->_var['account']['gold_coin']; ?>
        <?php endif; ?>
      </td>
      <td align="right">
