...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	$is_static = isset($_POST['is_static']) ? 1 : 0;
	$give_cash = isset($_POST['give_cash']) ? sprintf("%2f",floatval($_POST['give_cash'])) : '0';
	
	$good_cost = isset($_POST['good_cost']) ? sprintf("%2f",floatval($_POST['good_cost'])) : '0';
	$op_cost = isset($_POST['op_cost']) ? sprintf("%2f",floatval($_POST['op_cost'])) : '0';
	$other_cost = isset($_POST['other_cost']) ? sprintf("%2f",floatval($_POST['other_cost'])) : '0';
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale,is_static,give_cash,good_cost,op_cost,other_cost, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale',$is_static,$give_cash,$good_cost,$op_cost,$other_cost, '$is_alone_sale', $is_shipping, ".
        ...
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale,is_static,give_cash,good_cost,op_cost,other_cost, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale',$is_static,$give_cash,$good_cost,$op_cost,$other_cost, '$is_alone_sale', $is_shipping, ".
