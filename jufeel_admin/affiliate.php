...
elseif ($_REQUEST['act'] == 'updata')
{
	...
	$_POST['cash_lev_teyue'] = (float)$_POST['cash_lev_teyue'];
    $_POST['cash_lev_teyue'] > 100 && $_POST['cash_lev_teyue'] = 100;
	$_POST['cash_lev_1'] = (float)$_POST['cash_lev_1'];
    $_POST['cash_lev_1'] > 100 && $_POST['cash_lev_1'] = 100;
	$_POST['cash_lev_2'] = (float)$_POST['cash_lev_2'];
    $_POST['cash_lev_2'] > 100 && $_POST['cash_lev_2'] = 100;
	...
	if (!empty($_POST['cash_lev_teyue']) && strpos($_POST['cash_lev_teyue'],'%') === false)
    {
        $_POST['cash_lev_teyue'] .= '%';
    }
	if (!empty($_POST['cash_lev_1']) && strpos($_POST['cash_lev_1'],'%') === false)
    {
        $_POST['cash_lev_1'] .= '%';
    }
	if (!empty($_POST['cash_lev_2']) && strpos($_POST['cash_lev_2'],'%') === false)
    {
        $_POST['cash_lev_2'] .= '%';
    }
	
    $_POST['level_register_all'] = intval($_POST['level_register_all']);
	$_POST['pay_register_all'] = intval($_POST['pay_register_all']);
    ...
    $temp['config'] = array('expire'                => $_POST['expire'],        //COOKIE过期数字
							...
							'pay_register_all'    =>$_POST['pay_register_all'], //推荐注册奖励银币
                            'level_register_up'     =>$_POST['level_register_up'],   //推荐注册奖励积分上限
							'cash_lev_teyue'     =>$_POST['cash_lev_teyue'],		//特约分成现金比
							'cash_lev_1'     =>$_POST['cash_lev_1'],				//县级分成现金比
							'cash_lev_2'     =>$_POST['cash_lev_2']					//市/区级分成现金比
          );
