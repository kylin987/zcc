...
//$modules['04_order']['02_order_list2']               = 'order.php?act=list2';
...
$modules['04_order']['05_order_export']         = 'order.php?act=export'; // 订单导出
...
$modules['06_stats']['op_list']               = 'op_list.php?act=list';
$modules['06_stats']['market_list']               = 'market_list.php?act=list';
...
$modules['08_members']['11_user_apply_manage']    = 'user_apply_manage.php?act=list';
$modules['08_members']['12_user_spree_manage']    = 'user_spree_manage.php?act=list';
$modules['08_members']['14_user_spree_price']    = 'user_spree_manage.php?act=price';
$modules['08_members']['15_user_spree_trade']    = 'user_spree_trade.php?act=list';
$modules['08_members']['16_user_dividend']    = 'user_dividend.php?act=list';
$modules['08_members']['17_user_stock']    = 'user_stock.php?act=list';
$modules['08_members']['18_user_back_stock']    = 'user_back_stock.php?act=list';
$modules['08_members']['19_user_back_stock2']    = 'user_stock.php?act=back_stock2';
$modules['08_members']['20_user_premium']    = 'user_stock.php?act=user_premium';
$modules['08_members']['21_user_zhuanzhang']    = 'user_zhuanzhang.php?act=list';
$modules['08_members']['22_user_account_log']    = 'user_account_log.php?act=list';
...
$modules['15_rec']['affiliate_ck']                  = 'affiliate_ck.php?act=list&zn=1';
