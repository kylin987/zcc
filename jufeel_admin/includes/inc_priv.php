...
//会员管理权限
	...
	$purview['18_surplus_action']      = 'surplus_action';
	...
	$purview['11_user_upid_manage'] = 'upid_manage';
	$purview['12_user_spree_manage'] = 'spree_manage';
	$purview['13_user_raply_manage'] = 'raply_manage';
	$purview['14_user_spree_price'] = 'spree_price';
	$purview['15_user_spree_trade'] = 'spree_trade';
    $purview['16_user_dividend'] = 'user_dividend';
    $purview['17_user_apply_manage'] = 'apply_manage';
	$purview['19_user_stock'] = 'user_stock';
	$purview['18_user_back_stock'] = 'user_back_stock';
	$purview['19_user_back_stock2'] = 'user_back_stock2';
	$purview['20_user_premium'] = 'user_premium';
	$purview['20_user_zhuanzhang'] = 'user_zhuanzhang';
	$purview['20_user_account_log'] = 'user_account_log';
...
//报表统计权限
	...
	$purview['op_list']            = 'sale_order_stats';
	$purview['market_list']            = 'sale_order_stats';
