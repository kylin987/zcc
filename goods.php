...
function get_package_goods_list($goods_id)
{
    ...
    foreach ($res as $tempkey => $value)
    {
        ...
        $sql = "SELECT pg.package_id, pg.goods_id, pg.goods_number, pg.admin_id, p.goods_attr, g.goods_sn,  g.seller_note, g.goods_name, g.market_price, g.goods_thumb, IFNULL(mp.user_price, g.shop_price * '$_SESSION[discount]') AS rank_price
