...
//代金券
$_LANG['user_coin'] = '代金券';
$_LANG['coin_pro_type'] = '类型';
$_LANG['coin'] = '数量';
$_LANG['current_coin'] = '您当前的可用代金券为：';
$_LANG['coin_log'] = '代金券明细';
$_LANG['zhuanzhang'] = '转账';
...
$_LANG['agreement'] = "我已看过并接受《<a href=\"article.php?id=6\" style=\"color:blue\" target=\"_blank\">法律声明</a>》";
...
$_LANG['your_order'] = '订单';
$_LANG['your_integral'] = '银币';
$_LANG['your_frozen_money'] = '冻结货款';
$_LANG['your_level'] = '您当前： %s ';
$_LANG['next_level'] = ',还需： %s 贡献点达到： %s ';
$_LANG['attention'] = '关注';
...
$_LANG['pay_register_all'] = '注册积分分成数(银币)';
