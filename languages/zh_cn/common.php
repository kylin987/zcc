...
$_LANG['comment_custom'] = '评论失败。只有购买过商品的注册会员才能发表评论。';
...
$_LANG['ws_remark2'] = '附加留言';
$_LANG['ws_order_submitted'] = '您的订单已提交成功，请记住您的订单号: %s。';
$_LANG['ws_price_list'] = '价格单';
$_LANG['ws_order_submitted2'] = '您的订单已提交成功，请记住您的订单号: %s。请确认您的收货信息与付款方式';
$_LANG['ws_return_order_info'] = '正在跳转到详情页...';
