...
$_LANG['lab_static'] = '是否固定积分：';
$_LANG['notice_static'] = '选中则为固定消耗上述积分，积分不够无法购买：';
$_LANG['lab_give_integral'] = '赠送消费积分数：';
$_LANG['lab_rank_integral'] = '赠送贡献点数数：';
$_LANG['lab_give_cash'] = '拿出分成的现金：';
$_LANG['notice_give_cash'] = '默认为0，填写本数值，对应的现金分成将以本数值为基数。注意：不是分给购买人';
$_LANG['lab_good_cost'] = '产品成本：';
$_LANG['notice_good_cost'] = '默认为0，填写单件产品的成本';
$_LANG['lab_op_cost'] = '运营成本：';
$_LANG['notice_op_cost'] = '默认为0，填写单件产品的运营成本';
$_LANG['lab_other_cost'] = '其他成本：';
$_LANG['notice_other_cost'] = '默认为0，填写单件产品的其他成本';
...
$_LANG['notice_rank_integral'] = '购买该商品时赠送贡献点数数,-1表示按商品价格赠送';
