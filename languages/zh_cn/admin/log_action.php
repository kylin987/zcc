...
$_LANG['log_action']['shenhe'] = '审核、提升';
$_LANG['log_action']['jihuo'] = '激活';
...
$_LANG['log_action']['daili'] = '代理申请、用户等级';
$_LANG['log_action']['spree'] = '大礼包';
$_LANG['log_action']['buy_spree'] = '购买大礼包';
$_LANG['log_action']['sell_spree'] = '出售大礼包';
$_LANG['log_action']['apply_pay_status'] = '代理付款信息';
$_LANG['log_action']['dividend'] = '分红信息';
$_LANG['log_action']['lc_dividend'] = '凌晨分红';
$_LANG['log_action']['lj_dividend'] = '立即分红';
