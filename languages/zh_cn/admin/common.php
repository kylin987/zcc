...
$_LANG['app_name'] = 'JUFEEL';

$_LANG['cp_home'] = '管理中心';

$_LANG['copyright'] = '版权所有 &copy; 2005-2016 河南千康元电子商务有限公司，并保留所有权利。';
...
$_LANG['05_order_export'] = '订单导出'; //代码增加 By www.yiit.cn
...
$_LANG['11_user_apply_manage'] = '合伙人申请';

$_LANG['12_user_spree_manage'] = '大礼包审核';

$_LANG['13_user_raply_manage'] = '提现银行管理';

$_LANG['14_user_spree_price'] = '大礼包定价';

$_LANG['15_user_spree_trade'] = '大礼包交易';

$_LANG['16_user_dividend'] = '分红';

$_LANG['17_user_stock'] = '用户股权';

$_LANG['18_user_back_stock'] = '退股明细';

$_LANG['19_user_back_stock2'] = '退股汇总';

$_LANG['20_user_premium'] = '入股汇总'; 

$_LANG['21_user_zhuanzhang'] = '往来转款明细';

$_LANG['22_user_account_log'] = '用户流水明细';
...
$_LANG['dl_stats']['name'] = '订单状态';
$_LANG['dl_stats'][0] = '<font color=red>未付款</font>';
$_LANG['dl_stats'][1] = '<font color=blue>已付款</font>';
$_LANG['dl_stats'][2] = '已取消';
$_LANG['dl_stats'][3] = '无效';
$_LANG['dl_stats'][4] = '退货';
$_LANG['dl_stats'][5] = '已付款';

$_LANG['dl_lev']['name'] = '代理名字';
$_LANG['dl_lev'][0] = '未知';
$_LANG['dl_lev'][1] = '铜牌';
$_LANG['dl_lev'][2] = '银牌';
$_LANG['dl_lev'][3] = '金牌';
...
$_LANG['dl_sh'][0] = '未审核';
$_LANG['dl_sh'][1] = '<font color=blue>已审核</font>';
$_LANG['dl_sh'][2] = '<font color=red>已驳回</font>';

$_LANG['spree_state'][0] = '未激活';
$_LANG['spree_state'][1] = '<font color=blue>已激活</font>';
$_LANG['is_build'][0] = '否';
$_LANG['is_build'][1] = '<font color=blue>是</font>';

$_LANG['trade_spree_status'][0] = '待审核';
$_LANG['trade_spree_status'][1] = '<font color=blue>已完成</font>';
$_LANG['trade_spree_status'][2] = '已取消';
$_LANG['trade_spree_status'][3] = '<font color=red>已驳回</font>';

$_LANG['trade_spree_type'][0] = '<font color=red>购买</font>';
$_LANG['trade_spree_type'][1] = '<font color=blue>出售</font>';


$_LANG['sell_spree_status'][1] = '<font color=blue>待售中</font>';
$_LANG['sell_spree_status'][2] = '已完成';
$_LANG['sell_spree_status'][3] = '<font color=red>已驳回</font>';

$_LANG['is_do'][0] = '未执行';
$_LANG['is_do'][1] = '<font color=blue>已执行</font>';
$_LANG['is_do'][2] = '<font color=red>凌晨执行</font>';


$_LANG['stock_status'][0] = '正常';
$_LANG['stock_status'][1] = '<font color=green>已完成</font>';
$_LANG['stock_status'][2] = '<font color=red>已失败</font>';

$_LANG['up_bonus'][0] = '未奖励';
$_LANG['up_bonus'][1] = '<font color=green>已奖励</font>';
$_LANG['up_bonus'][2] = '<font color=blue>已存储</font>';

$_LANG['do_type'][0] = '未操作';
$_LANG['do_type'][1] = '<font color=green>提现</font>';
$_LANG['do_type'][2] = '<font color=blue>转余额</font>';
...
$_LANG['change_type'][0] = '';
$_LANG['change_type'][1] = '';
$_LANG['change_type'][8] = '转账支出';
$_LANG['change_type'][9] = '转账收入';
$_LANG['change_type'][1] = '';
$_LANG['change_type'][2] = '';
$_LANG['change_type'][0] = '';
$_LANG['change_type'][20] = '入股金支付';
$_LANG['change_type'][30] = '平台分红';
$_LANG['change_type'][99] = '其他';
