...
$_LANG['surplus_action'] = '会员余额审核';
$_LANG['account_manage'] = '会员账户管理';
$_LANG['upid_manage'] = '推荐人管理';
$_LANG['spree_manage'] = '大礼包审核';
$_LANG['raply_manage'] = '提现银行管理';
$_LANG['spree_price'] = '大礼包定价';
$_LANG['spree_trade'] = '大礼包交易';
$_LANG['user_dividend'] = '分红';
$_LANG['apply_manage'] = '合伙人申请';
$_LANG['user_stock'] = '用户股权';
$_LANG['user_back_stock'] = '退股明细';
$_LANG['user_back_stock2'] = '退股汇总';
$_LANG['user_premium'] = '入股汇总';
$_LANG['user_zhuanzhang'] = '往来转款明细';
$_LANG['user_account_log'] = '用户流水明细';
