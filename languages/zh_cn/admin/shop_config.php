...
$_LANG['cfg_name']['double_time'] = '翻倍时间(天)';
$_LANG['cfg_name']['d_beishu'] = '翻倍倍数';
$_LANG['cfg_name']['market_value'] = '市值';
$_LANG['cfg_name']['pure_profit'] = '总纯利润';
$_LANG['cfg_name']['no_dis_profit'] = '未分配纯利润';
$_LANG['cfg_name']['pe_ratios'] = '市盈率';
$_LANG['cfg_name']['premium'] = '入股金设置';
$_LANG['cfg_name']['all_premium'] = '总入股金';
$_LANG['cfg_name']['no_compute_premium'] = '今日未计算入股金';
$_LANG['cfg_name']['assess_time'] = '合伙人考核周期(天)';
$_LANG['cfg_name']['assess_value'] = '合伙人考核金额(元)';
$_LANG['cfg_name']['day_interest'] = '当前入股金每日利息(元)';
$_LANG['cfg_name']['partner_number'] = '合伙人数量';
$_LANG['cfg_name']['year_assess_time'] = '年度考核时间(年-月)';
...
$_LANG['cfg_desc']['d_beishu'] = '以当前代金券翻倍，翻1倍，写2';
