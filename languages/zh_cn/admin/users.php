...
$_LANG['sex'][1] = '男';
$_LANG['sex'][2] = '女';
$_LANG['pay_points'] = '消费积分(银币)';
$_LANG['rank_points'] = '贡献点数';
...
$_LANG['notice_rank_points'] = '贡献点数是一种累计的积分，系统根据该积分来判定用户的会员等级。';
...
$_LANG['list_send_hb_confirm'] = '您确定要给所有选中的会员发放红包吗？';
...
$_LANG['no_select_user'] = '您现在没有选中的会员！';
$_LANG['batch_send_hb'] = '成功发放 %d 个，失败 %d 个会员账号。';
...
$_LANG['js_languages']['invalid_rank_points'] = '贡献点数数不是一个整数。';
